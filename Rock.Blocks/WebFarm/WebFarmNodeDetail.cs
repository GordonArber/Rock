...
namespace Rock.Blocks.WebFarm
{
    ...
    public class WebFarmNodeDetail : RockObsidianDetailBlockType
    {
        ...
        private bool UpdateEntityFromBox( WebFarmNode entity, DetailBlockBox<WebFarmNodeBag, WebFarmNodeDetailOptionsBag> box, RockContext rockContext )
        {
            ...
            box.IfValidProperty( nameof( box.Entity.CurrentLeadershipPollingIntervalSeconds ),
                () => entity.CurrentLeadershipPollingIntervalSeconds = box.Entity.CurrentLeadershipPollingIntervalSeconds );

            box.IfValidProperty( nameof( box.Entity.IsActive ),
                () => entity.IsActive = box.Entity.IsActive );

            box.IfValidProperty( nameof( box.Entity.IsCurrentJobRunner ),
                () => entity.IsCurrentJobRunner = box.Entity.IsCurrentJobRunner );

            box.IfValidProperty( nameof( box.Entity.IsLeader ),
                () => entity.IsLeader = box.Entity.IsLeader );

            box.IfValidProperty( nameof( box.Entity.LastSeenDateTime ),
                () => entity.LastSeenDateTime = box.Entity.LastSeenDateTime );
