...
namespace Rock.Web.UI.Controls
{
    ...
    public class PreRegistrationChildRow : CompositeControl
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [show race and ethnicity].
        /// </summary>
        /// <value>
        ///   <c>true</c> if [show race and ethnicity]; otherwise, <c>false</c>.
        /// </value>
        public bool ShowRaceAndEthnicity
        {
            get
            {
                EnsureChildControls();
                return _rpRace.Visible && _epEthnicity.Visible;
            }
            set
            {
                EnsureChildControls();
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [require race and ethnicity].
        /// </summary>
        /// <value>
        ///   <c>true</c> if [require race and ethnicity]; otherwise, <c>false</c>.
        /// </value>
        public bool RequireRaceAndEthnicity
        {
            get
            {
                EnsureChildControls();
                return _rpRace.Required && _epEthnicity.Required;
            }
            set
            {
                EnsureChildControls();
