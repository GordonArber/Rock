...
namespace Rock.Web.UI.Controls
{
    ...
    public class PersonBasicEditor : CompositeControl, IHasValidationGroup
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [show raceAndEthicity].
        /// </summary>
        /// <value>
        ///   <c>true</c> if [show raceAndEthicity]; otherwise, <c>false</c>.
        /// </value>
        public bool ShowRaceAndEthicity
        {
            get
            {
                EnsureChildControls();
            ...
            {
                EnsureChildControls();
                _rpRace.Visible = _epEthnicity.Visible = value;
            }
        }

        /// <summary>
        /// Gets or sets a value indicating whether [require raceAndEthicity].
        /// </summary>
        /// <value>
        ///   <c>true</c> if [require raceAndEthicity]; otherwise, <c>false</c>.
        /// </value>
        public bool RequireRaceAndEthicity
        {
            get
            {
                EnsureChildControls();
            ...
            {
                EnsureChildControls();
                _rpRace.Required = _epEthnicity.Required = value;
            }
        }
        ...
        public void UpdatePerson( Person person, RockContext rockContext )
        {
            ...
            if ( ShowRaceAndEthicity )
            {
                person.RaceValueId = _rpRace.SelectedValueAsId();
                person.EthnicityValueId = _epEthnicity.SelectedValueAsId();
            }
