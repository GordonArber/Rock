...
";
        ...
        private void SetExtraRestParams()
        {
            ...
            extraParams.Append( "?activeOnly=" ).Append( activeOnly ).Append( "&displayPublicName=" ).Append( this.DisplayPublicName ).Append( "&accountsType=" ).Append( DisplayChildItemCountLabel ? AccountTreeViewItem.GetCountsType.ChildGroups : AccountTreeViewItem.GetCountsType.None );
